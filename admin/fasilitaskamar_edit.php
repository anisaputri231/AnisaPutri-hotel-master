<?php
  include "../koneksi.php";
  $id = $_GET['id'];
  $edit = $conn->query("SELECT * FROM fasilitas_kamar WHERE fasilitaskamar_id='$id'");
...
if(isset($_POST['simpan']))
{
    ...
    if ($tipekamar !==''){
        $add = $conn->query("UPDATE fasilitas_kamar SET kamar_id='$tipekamar', fasilitas='$fasilitas' WHERE fasilitaskamar_id='$id'");
        if ($add) {
